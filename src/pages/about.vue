  ...
  <div>
    <div class="d-flex align-items-start bg-light mb-3"> 
      <div class="col">
        ...
        satisfaction client, service, partage, innovation et conseil. Il ne
        s'agit pas de vendre pour vendre, mais de proposer le bon produit à la
        bonne personne, dans une relation de confiance.
      </div>
    </div>
  </div>
</template>
